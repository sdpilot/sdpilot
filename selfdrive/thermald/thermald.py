...
def thermald_thread():
  ...
  while True:
    ...
    msg.deviceState.freeSpacePercent = 100.0 #get_available_percent(default=100.0)
    ...
    if not HARDWARE.get_usb_present() and HARDWARE.get_battery_status() == 'Discharging' and HARDWARE.get_battery_current() > 0:
      should_start = False
